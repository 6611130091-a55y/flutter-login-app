...
//                   if (!v.endsWith('@email.com')) {
//                     return 'ต้องเป็น @email.com';
//                   }
//                   return null;
//                 },
//               ),
...
//                 ),
//                 validator: (v) {
//                   if (v == null || v.isEmpty) return 'กรุณากรอกเบอร์';
//                   if (!RegExp(r'^0\d{9}$').hasMatch(v)) {
//                     return 'เบอร์ไม่ถูกต้อง (10 หลัก)';
//                   }
//                   return null;
//                 },
//               ),
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                validator: (v) => v!.contains("@") ? null : "Email ไม่ถูกต้อง",
              ),
              TextFormField(
                controller: phoneCtrl,
                decoration: const InputDecoration(labelText: "Phone"),
                keyboardType: TextInputType.phone,
                validator: (v) => v!.length >= 10 ? null : "เบอร์ไม่ถูกต้อง",
              ),
              const SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
